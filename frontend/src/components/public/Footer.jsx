        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <img src="/logo-medimundo-v2.webp" alt="MediMundo — Tienda de Ortopedia y Equipo Médico en Querétaro" className="h-8" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>Av. Canad&aacute; 230, Plaza de las Am&eacute;ricas, Col. Carretas, Quer&eacute;taro</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+5214426156649" className="hover:text-white transition-colors">442 615 66 49</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="h-4 w-4 shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                </svg>
                <span>L-V: 10am–7pm &nbsp;|&nbsp; S&aacute;b: 10am–3pm</span>
              </li>
              <li>
                <a
