        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <img src="/logo-medimundo.png" alt="MediMundo" className="h-8" />
            </Link>
            <p className="text-sm leading-relaxed">
              Renta de equipo médico a domicilio en Querétaro. Equipos sanitizados,
              entrega rápida y soporte continuo.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/nosotros" className="hover:text-primary-400 transition-colors">Nosotros</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>Blvd. Bernardo Quintana 200, Col. Loma Dorada, Quer&eacute;taro, Qro. 76060</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+524421234567" className="hover:text-white transition-colors">(442) 123-4567</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="h-4 w-4 shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                </svg>
                <span>Lun-S&aacute;b 8:00 AM - 8:00 PM</span>
              </li>
              <li>
                <a
              ...
              <li>
                <a href="mailto:info@medimundo.com" className="hover:text-white transition-colors">info@medimundo.com</a>
              </li>
            </ul>
            {/* Social links */}
            <div className="mt-4 flex gap-3">
              <a href="https://facebook.com/medimundo" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-800 text-gray-400 hover:bg-blue-600 hover:text-white transition-colors" aria-label="Facebook">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://instagram.com/medimundo" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-800 text-gray-400 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 hover:text-white transition-colors" aria-label="Instagram">
