          ...
          <div className="mt-8 grid grid-cols-2 gap-6 lg:grid-cols-4">
            {STEPS.map((step, i) => (
              <div key={i} className="relative flex flex-col items-center text-center">
                ...
                <span className="mt-1 text-xs font-bold text-sky-600">Paso {i + 1}</span>
...
const STEPS = [
  { Icon: IconMagnify, title: "Elige", desc: "Explora nuestro catálogo y encuentra el equipo que necesitas." },
  { Icon: IconClipboard, title: "Solicita", desc: "Envía tu solicitud de renta por WhatsApp." },
  { Icon: IconTruck, title: "Recibe", desc: "Te lo entregamos sanitizado a domicilio en Querétaro." },
  { Icon: IconArrowPath, title: "Devuelve", desc: "Al finalizar tu renta, pasamos a recogerlo sin costo." },
];
