...
function ParallaxHero() {
  ...
  return (
    ...
    >
      {/* Overlay: light blue-white gradient for readability */}
      <div
        className="absolute inset-0"
        style={{
          background: 'linear-gradient(135deg, rgba(59,130,246,0.82) 0%, rgba(147,197,253,0.70) 40%, rgba(255,255,255,0.55) 100%)',
        }}
      />
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          className="absolute inset-0"
          style={{ background: 'linear-gradient(90deg, rgba(15,23,42,0.88) 0%, rgba(15,23,42,0.60) 55%, rgba(15,23,42,0.10) 100%)' }}
        />
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <div className="max-w-lg">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/catalogo?slug=concentradores-de-oxigeno"
