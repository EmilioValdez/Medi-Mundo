        ...
        <section>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {RECARGAS.map((r) => (
              <div
                key={r.litros}
                className="flex flex-col items-center rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:shadow-md hover:border-primary-300 transition-all text-center"
              >
                {/* Litros */}
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-sm font-medium text-gray-500">Litros</span>
                </div>

                {/* Tag */}
                <span className="mt-2 inline-block rounded-full bg-primary-50 px-3 py-0.5 text-xs font-medium text-primary-700">
                  Recarga en tienda
                </span>
                ...
                <div className="mt-4">
                  {r.precio !== null ? (
                    <>
                      <span className="text-2xl font-bold text-primary-600">{formatMXN(r.precio)}</span>
                      <span className="block text-xs text-gray-400 mt-0.5">precio por recarga</span>
                    </>
                  ) : (
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-whatsapp mt-4 w-full justify-center text-xs py-2"
                >
